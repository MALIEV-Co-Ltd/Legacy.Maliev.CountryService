...
public sealed class WorkflowContractTests
{
    ...
    private static readonly string ApiProject = File.ReadAllText(
        FindRepositoryFile("Legacy.Maliev.CountryService.Api", "Legacy.Maliev.CountryService.Api.csproj"));
    private static readonly string DataProject = File.ReadAllText(
        FindRepositoryFile("Legacy.Maliev.CountryService.Data", "Legacy.Maliev.CountryService.Data.csproj"));
    ...
    public void EfDesignDependency_IsOwnedByDataProjectOnly()
    {
        ...
        Assert.Contains("<PrivateAssets>all</PrivateAssets>", DataProject, StringComparison.Ordinal);
    }
